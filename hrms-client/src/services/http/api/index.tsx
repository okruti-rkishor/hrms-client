...
export default {
    ...
    documentUpload: (data: any,id:string) => rest.post(base + "s3/upload", {}, data, {"employee-id":id}, {'Content-Type': 'multipart/form-data'}),
    ...
    getDocument:(id:string)=>rest.get(base+"document/find",{},{'employeeId':id}),
    changeStatus:(id:string)=>rest.put(base+`document/${id}/updateStatus`,{id},{},{}),
