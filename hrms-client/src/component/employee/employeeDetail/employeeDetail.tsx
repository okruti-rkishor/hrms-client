          ...
          {(employeeData?.familyDetails ?? 0) &&
            employeeData?.familyDetails.map((familydetail: any) => (
                ...
                >
                  ...
                  {/* <Divider><img style={{width:"16px",height:"16px"}} src="https://img.freepik.com/premium-vector/father-family-memeber-avatar-vector-illustration-design_24877-15519.jpg" alt="..." /> {familydetail.relationType==="Mother"?"Mother":familydetail.relationType===("Father")?"Father":"Spouse"}</Divider> */}
                  <span>
                    Relation with Employee: {familydetail.relationType}
                  </span>
                  <span>Name: {familydetail.name}</span>
                  <span>Mobile Number : {familydetail.mobileNumber}</span>
                </div>
        ...
        <div className="bank-detail card">
          <div className="personal-detail">
            ...
            className="detail-card"
              ...
              // }}
            >
              <Divider><img className="logo" src="https://w7.pngwing.com/pngs/223/204/png-transparent-bank-logo-bank-saving-bank-pic-building-structure-bank-thumbnail.png" alt="" /> Account Information</Divider>
              <span>
                Account Number:{" "}
                {employeeData.bankDetails
                  ? employeeData.bankDetails[0]?.accountNumber
